...
static void mavlink_test_euler_debug(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("EULER_DEBUG") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_EULER_DEBUG) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("AIRDATA") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_AIRDATA) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("AIRDATA_5_hole") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_AIRDATA_5_hole) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("CONTROL_FEEDBACK") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_CONTROL_FEEDBACK) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("PROPULSION") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_PROPULSION) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("POWER") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_POWER) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("SERVO_NODE") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_SERVO_NODE) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("IMU_DEBUG") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_IMU_DEBUG) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("ACCEL_DEBUG") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_ACCEL_DEBUG) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("MAG_DEBUG") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_MAG_DEBUG) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("FDR_STATUS") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_FDR_STATUS) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("Longitudinal") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_Longitudinal) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("Lateral") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_Lateral) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("WEATHER") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_WEATHER) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("SPEKTRUM_LINK") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_SPEKTRUM_LINK) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("FUEL_CELL") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_FUEL_CELL) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("FUEL_CELL_DETAIL") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_FUEL_CELL_DETAIL) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("PID_TUNE") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_PID_TUNE) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("VEHICLE_STATE") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_VEHICLE_STATE) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("EKF_DEBUG") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_EKF_DEBUG) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("EKF_HEALTH") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_EKF_HEALTH) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("TECS_DEBUG") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_TECS_DEBUG) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("MR_DEBUG") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_MR_DEBUG) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("SENSOR_ID") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_SENSOR_ID) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("ATTITUDE_SENSOR") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_ATTITUDE_SENSOR) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("AIRDATA_SENSOR") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_AIRDATA_SENSOR) != NULL);
#endif
}

static void mavlink_test_rc_data_in(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
#ifdef MAVLINK_STATUS_FLAG_OUT_MAVLINK1
    mavlink_status_t *status = mavlink_get_channel_status(MAVLINK_COMM_0);
        if ((status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) && MAVLINK_MSG_ID_RC_DATA_IN >= 256) {
            return;
        }
#endif
    mavlink_message_t msg;
        uint8_t buffer[MAVLINK_MAX_PACKET_LEN];
        uint16_t i;
    mavlink_rc_data_in_t packet_in = {
        963497464,963497672,963497880,101.0,129.0,157.0,185.0,213.0,241.0,269.0,19315,19419,19523,19627,19731,19835,19939,20043,20147,20251,20355,20459,20563,20667,20771,20875,20979,99
    };
    mavlink_rc_data_in_t packet1, packet2;
        memset(&packet1, 0, sizeof(packet1));
        packet1.Sensor_time_UNIT_100us = packet_in.Sensor_time_UNIT_100us;
        packet1.Sync_data_UNIT_variable = packet_in.Sync_data_UNIT_variable;
        packet1.Recorded_time_UNIT_100us = packet_in.Recorded_time_UNIT_100us;
        ...
        packet1.ADC_3_UNIT_V = packet_in.ADC_3_UNIT_V;
        packet1.ADC_4_UNIT_V = packet_in.ADC_4_UNIT_V;
        packet1.d1 = packet_in.d1;
        packet1.d2 = packet_in.d2;
        packet1.d3 = packet_in.d3;
        packet1.Sensor_processing_time_UNIT_us = packet_in.Sensor_processing_time_UNIT_us;
        ...
        packet1.SignalHold_UNIT_none = packet_in.SignalHold_UNIT_none;
        packet1.SignalFrameLoss_UNIT_none = packet_in.SignalFrameLoss_UNIT_none;
        packet1.SignalFadesMain_UNIT_none = packet_in.SignalFadesMain_UNIT_none;
        packet1.SignalFadesSat1_UNIT_none = packet_in.SignalFadesSat1_UNIT_none;
        ...
        if (status->flags & MAVLINK_STATUS_FLAG_OUT_MAVLINK1) {
           // cope with extensions
           memset(MAVLINK_MSG_ID_RC_DATA_IN_MIN_LEN + (char *)&packet1, 0, sizeof(packet1)-MAVLINK_MSG_ID_RC_DATA_IN_MIN_LEN);
        }
#endif
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_rc_data_in_encode(system_id, component_id, &msg, &packet1);
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("RC_DATA_IN") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_RC_DATA_IN) != NULL);
#endif
}
...
static void mavlink_test_actuator_command_out(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_actuator_command_out_t packet_in = {
        963497464,963497672,963497880,101.0,129.0,157.0,185.0,213.0,18899,19003,19107,19211,19315,19419,19523,19627,19731
    };
    mavlink_actuator_command_out_t packet1, packet2;
        ...
        packet1.Sync_data_UNIT_variable = packet_in.Sync_data_UNIT_variable;
        packet1.Recorded_time_UNIT_100us = packet_in.Recorded_time_UNIT_100us;
        packet1.Telem_1 = packet_in.Telem_1;
        packet1.Telem_2 = packet_in.Telem_2;
        packet1.d1 = packet_in.d1;
        packet1.d2 = packet_in.d2;
        packet1.d3 = packet_in.d3;
        packet1.Sensor_processing_time_UNIT_us = packet_in.Sensor_processing_time_UNIT_us;
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("ACTUATOR_COMMAND_OUT") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_ACTUATOR_COMMAND_OUT) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("ACTUATOR_FEEDBACK") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_ACTUATOR_FEEDBACK) != NULL);
#endif
}
...
static void mavlink_test_power_sensor(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_power_sensor_t packet_in = {
        963497464,963497672,963497880,101.0,129.0,157.0,185.0,213.0,241.0,269.0,297.0,325.0,19731,19835
    };
    mavlink_power_sensor_t packet1, packet2;
        ...
        packet1.Sync_data_UNIT_variable = packet_in.Sync_data_UNIT_variable;
        packet1.Recorded_time_UNIT_100us = packet_in.Recorded_time_UNIT_100us;
        packet1.Motor_Voltage_UNIT_V = packet_in.Motor_Voltage_UNIT_V;
        packet1.Motor_Current_UNIT_A = packet_in.Motor_Current_UNIT_A;
        packet1.Motor_Power_UNIT_W = packet_in.Motor_Power_UNIT_W;
        packet1.Motor_Temp_UNIT_C = packet_in.Motor_Temp_UNIT_C;
        packet1.Servo_Voltage_UNIT_V = packet_in.Servo_Voltage_UNIT_V;
        packet1.Servo_Current_UNIT_A = packet_in.Servo_Current_UNIT_A;
        packet1.System_Voltage_UNIT_V = packet_in.System_Voltage_UNIT_V;
        packet1.System_Current_UNIT_A = packet_in.System_Current_UNIT_A;
    ...
    mavlink_msg_power_sensor_decode(&msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_power_sensor_pack(system_id, component_id, &msg , packet1.Sensor_time_UNIT_100us , packet1.Sync_data_UNIT_variable , packet1.Sensor_processing_time_UNIT_us , packet1.Recorded_time_UNIT_100us , packet1.Motor_Voltage_UNIT_V , packet1.Motor_Current_UNIT_A , packet1.Motor_Power_UNIT_W , packet1.Motor_Temp_UNIT_C , packet1.RPM_UNIT_1_d_sec , packet1.Servo_Voltage_UNIT_V , packet1.Servo_Current_UNIT_A , packet1.System_Voltage_UNIT_V , packet1.System_Current_UNIT_A , packet1.Temp_UNIT_C );
    mavlink_msg_power_sensor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_power_sensor_pack_chan(system_id, component_id, MAVLINK_COMM_0, &msg , packet1.Sensor_time_UNIT_100us , packet1.Sync_data_UNIT_variable , packet1.Sensor_processing_time_UNIT_us , packet1.Recorded_time_UNIT_100us , packet1.Motor_Voltage_UNIT_V , packet1.Motor_Current_UNIT_A , packet1.Motor_Power_UNIT_W , packet1.Motor_Temp_UNIT_C , packet1.RPM_UNIT_1_d_sec , packet1.Servo_Voltage_UNIT_V , packet1.Servo_Current_UNIT_A , packet1.System_Voltage_UNIT_V , packet1.System_Current_UNIT_A , packet1.Temp_UNIT_C );
    mavlink_msg_power_sensor_decode(&msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);
    ...
    mavlink_msg_power_sensor_decode(last_msg, &packet2);
        ...
        memset(&packet2, 0, sizeof(packet2));
    mavlink_msg_power_sensor_send(MAVLINK_COMM_1 , packet1.Sensor_time_UNIT_100us , packet1.Sync_data_UNIT_variable , packet1.Sensor_processing_time_UNIT_us , packet1.Recorded_time_UNIT_100us , packet1.Motor_Voltage_UNIT_V , packet1.Motor_Current_UNIT_A , packet1.Motor_Power_UNIT_W , packet1.Motor_Temp_UNIT_C , packet1.RPM_UNIT_1_d_sec , packet1.Servo_Voltage_UNIT_V , packet1.Servo_Current_UNIT_A , packet1.System_Voltage_UNIT_V , packet1.System_Current_UNIT_A , packet1.Temp_UNIT_C );
    mavlink_msg_power_sensor_decode(last_msg, &packet2);
        MAVLINK_ASSERT(memcmp(&packet1, &packet2, sizeof(packet1)) == 0);

#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("POWER_SENSOR") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_POWER_SENSOR) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("THRUST_SENSOR") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_THRUST_SENSOR) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("ADC_ARDUINO_8CH") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_ADC_ARDUINO_8CH) != NULL);
#endif
}
...
#ifdef MAVLINK_HAVE_GET_MESSAGE_INFO
    MAVLINK_ASSERT(mavlink_get_message_info_by_name("IMU_3DoF") != NULL);
    MAVLINK_ASSERT(mavlink_get_message_info_by_id(MAVLINK_MSG_ID_IMU_3DoF) != NULL);
#endif
}
...
static void mavlink_test_UAVmainframe_v6a(uint8_t system_id, uint8_t component_id, mavlink_message_t *last_msg)
{
    ...
    mavlink_test_rc_data_in(system_id, component_id, last_msg);
