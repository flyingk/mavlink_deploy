						       ...
						       uint32_t time_boot_ms, uint8_t Holds, uint16_t Frame_loss, uint16_t Fade_main, uint16_t Fade_sat_1, uint16_t Fade_sat_2, uint16_t Fade_sat_3)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_SPEKTRUM_LINK_LEN, MAVLINK_MSG_ID_SPEKTRUM_LINK_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_SPEKTRUM_LINK_LEN);
#endif
}
						           ...
						           uint32_t time_boot_ms,uint8_t Holds,uint16_t Frame_loss,uint16_t Fade_main,uint16_t Fade_sat_1,uint16_t Fade_sat_2,uint16_t Fade_sat_3)
{
	...
	msg->msgid = MAVLINK_MSG_ID_SPEKTRUM_LINK;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_SPEKTRUM_LINK_LEN, MAVLINK_MSG_ID_SPEKTRUM_LINK_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_SPEKTRUM_LINK_LEN);
#endif
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SPEKTRUM_LINK, buf, MAVLINK_MSG_ID_SPEKTRUM_LINK_LEN, MAVLINK_MSG_ID_SPEKTRUM_LINK_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SPEKTRUM_LINK, buf, MAVLINK_MSG_ID_SPEKTRUM_LINK_LEN);
#endif
#else
	mavlink_spektrum_link_t packet;
	packet.time_boot_ms = time_boot_ms;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SPEKTRUM_LINK, (const char *)&packet, MAVLINK_MSG_ID_SPEKTRUM_LINK_LEN, MAVLINK_MSG_ID_SPEKTRUM_LINK_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SPEKTRUM_LINK, (const char *)&packet, MAVLINK_MSG_ID_SPEKTRUM_LINK_LEN);
#endif
#endif
}
...
#else
	memcpy(spektrum_link, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_SPEKTRUM_LINK_LEN);
#endif
}
