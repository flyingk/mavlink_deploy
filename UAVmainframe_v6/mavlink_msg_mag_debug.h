...
#define MAVLINK_MSG_ID_MAG_DEBUG_MIN_LEN 22
#define MAVLINK_MSG_ID_189_LEN 22
#define MAVLINK_MSG_ID_189_MIN_LEN 22
                               ...
                               uint32_t time_boot_ms, int16_t imu_mx, int16_t imu_my, int16_t imu_mz, int16_t tail_mx, int16_t tail_my, int16_t tail_mz, int16_t wing_mx, int16_t wing_my, int16_t wing_mz)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_MAG_DEBUG_MIN_LEN, MAVLINK_MSG_ID_MAG_DEBUG_LEN, MAVLINK_MSG_ID_MAG_DEBUG_CRC);
}
                                   ...
                                   uint32_t time_boot_ms,int16_t imu_mx,int16_t imu_my,int16_t imu_mz,int16_t tail_mx,int16_t tail_my,int16_t tail_mz,int16_t wing_mx,int16_t wing_my,int16_t wing_mz)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_MAG_DEBUG;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_MAG_DEBUG_MIN_LEN, MAVLINK_MSG_ID_MAG_DEBUG_LEN, MAVLINK_MSG_ID_MAG_DEBUG_CRC);
}
...
static inline void mavlink_msg_mag_debug_send(mavlink_channel_t chan, uint32_t time_boot_ms, int16_t imu_mx, int16_t imu_my, int16_t imu_mz, int16_t tail_mx, int16_t tail_my, int16_t tail_mz, int16_t wing_mx, int16_t wing_my, int16_t wing_mz)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MAG_DEBUG, buf, MAVLINK_MSG_ID_MAG_DEBUG_MIN_LEN, MAVLINK_MSG_ID_MAG_DEBUG_LEN, MAVLINK_MSG_ID_MAG_DEBUG_CRC);
#else
    mavlink_mag_debug_t packet;
    packet.time_boot_ms = time_boot_ms;
    packet.imu_mx = imu_mx;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MAG_DEBUG, (const char *)&packet, MAVLINK_MSG_ID_MAG_DEBUG_MIN_LEN, MAVLINK_MSG_ID_MAG_DEBUG_LEN, MAVLINK_MSG_ID_MAG_DEBUG_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_mag_debug_send_struct(mavlink_channel_t chan, const mavlink_mag_debug_t* mag_debug)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_mag_debug_send(chan, mag_debug->time_boot_ms, mag_debug->imu_mx, mag_debug->imu_my, mag_debug->imu_mz, mag_debug->tail_mx, mag_debug->tail_my, mag_debug->tail_mz, mag_debug->wing_mx, mag_debug->wing_my, mag_debug->wing_mz);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MAG_DEBUG, (const char *)mag_debug, MAVLINK_MSG_ID_MAG_DEBUG_MIN_LEN, MAVLINK_MSG_ID_MAG_DEBUG_LEN, MAVLINK_MSG_ID_MAG_DEBUG_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_MAG_DEBUG_LEN? msg->len : MAVLINK_MSG_ID_MAG_DEBUG_LEN;
        memset(mag_debug, 0, MAVLINK_MSG_ID_MAG_DEBUG_LEN);
    memcpy(mag_debug, _MAV_PAYLOAD(msg), len);
#endif
}
