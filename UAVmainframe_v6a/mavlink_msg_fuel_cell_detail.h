...
#define MAVLINK_MSG_ID_FUEL_CELL_DETAIL_MIN_LEN 22
#define MAVLINK_MSG_ID_196_LEN 22
#define MAVLINK_MSG_ID_196_MIN_LEN 22
                               ...
                               uint32_t time_boot_ms, uint16_t FC_Aux_V2, uint16_t FC_Aux_A2, uint16_t FC_Aux_V3, uint16_t FC_Aux_A3, uint16_t FC_Mass_flow, uint16_t FC_Pressure, uint16_t FC_Airflow, uint16_t FC_RPM_1, uint16_t FC_RPM_2)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_MIN_LEN, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_LEN, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_CRC);
}
                                   ...
                                   uint32_t time_boot_ms,uint16_t FC_Aux_V2,uint16_t FC_Aux_A2,uint16_t FC_Aux_V3,uint16_t FC_Aux_A3,uint16_t FC_Mass_flow,uint16_t FC_Pressure,uint16_t FC_Airflow,uint16_t FC_RPM_1,uint16_t FC_RPM_2)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_FUEL_CELL_DETAIL;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_MIN_LEN, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_LEN, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_CRC);
}
...
static inline void mavlink_msg_fuel_cell_detail_send(mavlink_channel_t chan, uint32_t time_boot_ms, uint16_t FC_Aux_V2, uint16_t FC_Aux_A2, uint16_t FC_Aux_V3, uint16_t FC_Aux_A3, uint16_t FC_Mass_flow, uint16_t FC_Pressure, uint16_t FC_Airflow, uint16_t FC_RPM_1, uint16_t FC_RPM_2)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FUEL_CELL_DETAIL, buf, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_MIN_LEN, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_LEN, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_CRC);
#else
    mavlink_fuel_cell_detail_t packet;
    packet.time_boot_ms = time_boot_ms;
    packet.FC_Aux_V2 = FC_Aux_V2;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FUEL_CELL_DETAIL, (const char *)&packet, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_MIN_LEN, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_LEN, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_fuel_cell_detail_send_struct(mavlink_channel_t chan, const mavlink_fuel_cell_detail_t* fuel_cell_detail)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_fuel_cell_detail_send(chan, fuel_cell_detail->time_boot_ms, fuel_cell_detail->FC_Aux_V2, fuel_cell_detail->FC_Aux_A2, fuel_cell_detail->FC_Aux_V3, fuel_cell_detail->FC_Aux_A3, fuel_cell_detail->FC_Mass_flow, fuel_cell_detail->FC_Pressure, fuel_cell_detail->FC_Airflow, fuel_cell_detail->FC_RPM_1, fuel_cell_detail->FC_RPM_2);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FUEL_CELL_DETAIL, (const char *)fuel_cell_detail, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_MIN_LEN, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_LEN, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_FUEL_CELL_DETAIL_LEN? msg->len : MAVLINK_MSG_ID_FUEL_CELL_DETAIL_LEN;
        memset(fuel_cell_detail, 0, MAVLINK_MSG_ID_FUEL_CELL_DETAIL_LEN);
    memcpy(fuel_cell_detail, _MAV_PAYLOAD(msg), len);
#endif
}
