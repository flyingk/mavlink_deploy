...
#define MAVLINK_MSG_ID_FDR_STATUS_MIN_LEN 14
#define MAVLINK_MSG_ID_190_LEN 14
#define MAVLINK_MSG_ID_190_MIN_LEN 14
                               ...
                               uint32_t time_boot_ms, uint8_t GPS_SAT, uint8_t GPS_FIX, uint8_t GPS_HDOP, uint8_t GPS_VDOP, uint8_t VN200_SAT, uint8_t VN200_FIX, uint8_t VN200_Status, uint8_t Radio_txbuff, uint8_t PWR_Gains, uint8_t CPU_load)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_FDR_STATUS_MIN_LEN, MAVLINK_MSG_ID_FDR_STATUS_LEN, MAVLINK_MSG_ID_FDR_STATUS_CRC);
}
                                   ...
                                   uint32_t time_boot_ms,uint8_t GPS_SAT,uint8_t GPS_FIX,uint8_t GPS_HDOP,uint8_t GPS_VDOP,uint8_t VN200_SAT,uint8_t VN200_FIX,uint8_t VN200_Status,uint8_t Radio_txbuff,uint8_t PWR_Gains,uint8_t CPU_load)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_FDR_STATUS;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_FDR_STATUS_MIN_LEN, MAVLINK_MSG_ID_FDR_STATUS_LEN, MAVLINK_MSG_ID_FDR_STATUS_CRC);
}
...
static inline void mavlink_msg_fdr_status_send(mavlink_channel_t chan, uint32_t time_boot_ms, uint8_t GPS_SAT, uint8_t GPS_FIX, uint8_t GPS_HDOP, uint8_t GPS_VDOP, uint8_t VN200_SAT, uint8_t VN200_FIX, uint8_t VN200_Status, uint8_t Radio_txbuff, uint8_t PWR_Gains, uint8_t CPU_load)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FDR_STATUS, buf, MAVLINK_MSG_ID_FDR_STATUS_MIN_LEN, MAVLINK_MSG_ID_FDR_STATUS_LEN, MAVLINK_MSG_ID_FDR_STATUS_CRC);
#else
    mavlink_fdr_status_t packet;
    packet.time_boot_ms = time_boot_ms;
    packet.GPS_SAT = GPS_SAT;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FDR_STATUS, (const char *)&packet, MAVLINK_MSG_ID_FDR_STATUS_MIN_LEN, MAVLINK_MSG_ID_FDR_STATUS_LEN, MAVLINK_MSG_ID_FDR_STATUS_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_fdr_status_send_struct(mavlink_channel_t chan, const mavlink_fdr_status_t* fdr_status)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_fdr_status_send(chan, fdr_status->time_boot_ms, fdr_status->GPS_SAT, fdr_status->GPS_FIX, fdr_status->GPS_HDOP, fdr_status->GPS_VDOP, fdr_status->VN200_SAT, fdr_status->VN200_FIX, fdr_status->VN200_Status, fdr_status->Radio_txbuff, fdr_status->PWR_Gains, fdr_status->CPU_load);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FDR_STATUS, (const char *)fdr_status, MAVLINK_MSG_ID_FDR_STATUS_MIN_LEN, MAVLINK_MSG_ID_FDR_STATUS_LEN, MAVLINK_MSG_ID_FDR_STATUS_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_FDR_STATUS_LEN? msg->len : MAVLINK_MSG_ID_FDR_STATUS_LEN;
        memset(fdr_status, 0, MAVLINK_MSG_ID_FDR_STATUS_LEN);
    memcpy(fdr_status, _MAV_PAYLOAD(msg), len);
#endif
}
