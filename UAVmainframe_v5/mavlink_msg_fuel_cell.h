						       ...
						       uint32_t time_boot_ms, uint16_t FC_Volt, uint16_t FC_Amp, uint16_t FC_temp, uint16_t FC_Aux_V1, uint16_t FC_Aux_A1)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_FUEL_CELL_LEN, MAVLINK_MSG_ID_FUEL_CELL_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_FUEL_CELL_LEN);
#endif
}
						           ...
						           uint32_t time_boot_ms,uint16_t FC_Volt,uint16_t FC_Amp,uint16_t FC_temp,uint16_t FC_Aux_V1,uint16_t FC_Aux_A1)
{
	...
	msg->msgid = MAVLINK_MSG_ID_FUEL_CELL;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_FUEL_CELL_LEN, MAVLINK_MSG_ID_FUEL_CELL_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_FUEL_CELL_LEN);
#endif
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FUEL_CELL, buf, MAVLINK_MSG_ID_FUEL_CELL_LEN, MAVLINK_MSG_ID_FUEL_CELL_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FUEL_CELL, buf, MAVLINK_MSG_ID_FUEL_CELL_LEN);
#endif
#else
	mavlink_fuel_cell_t packet;
	packet.time_boot_ms = time_boot_ms;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FUEL_CELL, (const char *)&packet, MAVLINK_MSG_ID_FUEL_CELL_LEN, MAVLINK_MSG_ID_FUEL_CELL_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_FUEL_CELL, (const char *)&packet, MAVLINK_MSG_ID_FUEL_CELL_LEN);
#endif
#endif
}
...
#else
	memcpy(fuel_cell, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_FUEL_CELL_LEN);
#endif
}
