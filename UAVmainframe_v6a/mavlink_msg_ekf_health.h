...
#define MAVLINK_MSG_ID_EKF_HEALTH_MIN_LEN 30
                               ...
                               uint32_t time_boot_ms, int16_t Pn__cm, int16_t Pe__cm, int16_t Pd__cm, int16_t Vn__cmps, int16_t Ve__cmps, int16_t Vd__cmps, int16_t Vair__cmps, int16_t AoA__mdeg, int16_t CW__mdeg, int16_t Alt__cm, int16_t Mx__mG, int16_t My__mG, int16_t Mz__mG)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_EKF_HEALTH_MIN_LEN, MAVLINK_MSG_ID_EKF_HEALTH_LEN, MAVLINK_MSG_ID_EKF_HEALTH_CRC);
}
                                   ...
                                   uint32_t time_boot_ms,int16_t Pn__cm,int16_t Pe__cm,int16_t Pd__cm,int16_t Vn__cmps,int16_t Ve__cmps,int16_t Vd__cmps,int16_t Vair__cmps,int16_t AoA__mdeg,int16_t CW__mdeg,int16_t Alt__cm,int16_t Mx__mG,int16_t My__mG,int16_t Mz__mG)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_EKF_HEALTH;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_EKF_HEALTH_MIN_LEN, MAVLINK_MSG_ID_EKF_HEALTH_LEN, MAVLINK_MSG_ID_EKF_HEALTH_CRC);
}
...
static inline void mavlink_msg_ekf_health_send(mavlink_channel_t chan, uint32_t time_boot_ms, int16_t Pn__cm, int16_t Pe__cm, int16_t Pd__cm, int16_t Vn__cmps, int16_t Ve__cmps, int16_t Vd__cmps, int16_t Vair__cmps, int16_t AoA__mdeg, int16_t CW__mdeg, int16_t Alt__cm, int16_t Mx__mG, int16_t My__mG, int16_t Mz__mG)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EKF_HEALTH, buf, MAVLINK_MSG_ID_EKF_HEALTH_MIN_LEN, MAVLINK_MSG_ID_EKF_HEALTH_LEN, MAVLINK_MSG_ID_EKF_HEALTH_CRC);
#else
    mavlink_ekf_health_t packet;
    packet.time_boot_ms = time_boot_ms;
    packet.Pn__cm = Pn__cm;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EKF_HEALTH, (const char *)&packet, MAVLINK_MSG_ID_EKF_HEALTH_MIN_LEN, MAVLINK_MSG_ID_EKF_HEALTH_LEN, MAVLINK_MSG_ID_EKF_HEALTH_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_ekf_health_send_struct(mavlink_channel_t chan, const mavlink_ekf_health_t* ekf_health)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_ekf_health_send(chan, ekf_health->time_boot_ms, ekf_health->Pn__cm, ekf_health->Pe__cm, ekf_health->Pd__cm, ekf_health->Vn__cmps, ekf_health->Ve__cmps, ekf_health->Vd__cmps, ekf_health->Vair__cmps, ekf_health->AoA__mdeg, ekf_health->CW__mdeg, ekf_health->Alt__cm, ekf_health->Mx__mG, ekf_health->My__mG, ekf_health->Mz__mG);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EKF_HEALTH, (const char *)ekf_health, MAVLINK_MSG_ID_EKF_HEALTH_MIN_LEN, MAVLINK_MSG_ID_EKF_HEALTH_LEN, MAVLINK_MSG_ID_EKF_HEALTH_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_EKF_HEALTH_LEN? msg->len : MAVLINK_MSG_ID_EKF_HEALTH_LEN;
        memset(ekf_health, 0, MAVLINK_MSG_ID_EKF_HEALTH_LEN);
    memcpy(ekf_health, _MAV_PAYLOAD(msg), len);
#endif
}
