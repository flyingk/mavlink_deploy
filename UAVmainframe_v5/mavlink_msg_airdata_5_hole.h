						       ...
						       uint32_t time_boot_ms, uint16_t dynamic_pressure, float density, int8_t temperature, float DP1, float DP2, float DP3)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_AIRDATA_5_hole_LEN, MAVLINK_MSG_ID_AIRDATA_5_hole_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_AIRDATA_5_hole_LEN);
#endif
}
						           ...
						           uint32_t time_boot_ms,uint16_t dynamic_pressure,float density,int8_t temperature,float DP1,float DP2,float DP3)
{
	...
	msg->msgid = MAVLINK_MSG_ID_AIRDATA_5_hole;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_AIRDATA_5_hole_LEN, MAVLINK_MSG_ID_AIRDATA_5_hole_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_AIRDATA_5_hole_LEN);
#endif
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_AIRDATA_5_hole, buf, MAVLINK_MSG_ID_AIRDATA_5_hole_LEN, MAVLINK_MSG_ID_AIRDATA_5_hole_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_AIRDATA_5_hole, buf, MAVLINK_MSG_ID_AIRDATA_5_hole_LEN);
#endif
#else
	mavlink_airdata_5_hole_t packet;
	packet.time_boot_ms = time_boot_ms;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_AIRDATA_5_hole, (const char *)&packet, MAVLINK_MSG_ID_AIRDATA_5_hole_LEN, MAVLINK_MSG_ID_AIRDATA_5_hole_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_AIRDATA_5_hole, (const char *)&packet, MAVLINK_MSG_ID_AIRDATA_5_hole_LEN);
#endif
#endif
}
...
#else
	memcpy(airdata_5_hole, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_AIRDATA_5_hole_LEN);
#endif
}
