...
#define MAVLINK_MSG_ID_IMU_DEBUG_MIN_LEN 23
#define MAVLINK_MSG_ID_187_LEN 23
#define MAVLINK_MSG_ID_187_MIN_LEN 23
                               ...
                               uint32_t time_boot_ms, int16_t Ax, int16_t Ay, int16_t Az, int16_t Gx_u, int16_t Gy_u, int16_t Gz_u, int16_t Mx, int16_t My, int16_t Mz, int8_t IMU_temp)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_IMU_DEBUG_MIN_LEN, MAVLINK_MSG_ID_IMU_DEBUG_LEN, MAVLINK_MSG_ID_IMU_DEBUG_CRC);
}
                                   ...
                                   uint32_t time_boot_ms,int16_t Ax,int16_t Ay,int16_t Az,int16_t Gx_u,int16_t Gy_u,int16_t Gz_u,int16_t Mx,int16_t My,int16_t Mz,int8_t IMU_temp)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_IMU_DEBUG;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_IMU_DEBUG_MIN_LEN, MAVLINK_MSG_ID_IMU_DEBUG_LEN, MAVLINK_MSG_ID_IMU_DEBUG_CRC);
}
...
static inline void mavlink_msg_imu_debug_send(mavlink_channel_t chan, uint32_t time_boot_ms, int16_t Ax, int16_t Ay, int16_t Az, int16_t Gx_u, int16_t Gy_u, int16_t Gz_u, int16_t Mx, int16_t My, int16_t Mz, int8_t IMU_temp)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_IMU_DEBUG, buf, MAVLINK_MSG_ID_IMU_DEBUG_MIN_LEN, MAVLINK_MSG_ID_IMU_DEBUG_LEN, MAVLINK_MSG_ID_IMU_DEBUG_CRC);
#else
    mavlink_imu_debug_t packet;
    packet.time_boot_ms = time_boot_ms;
    packet.Ax = Ax;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_IMU_DEBUG, (const char *)&packet, MAVLINK_MSG_ID_IMU_DEBUG_MIN_LEN, MAVLINK_MSG_ID_IMU_DEBUG_LEN, MAVLINK_MSG_ID_IMU_DEBUG_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_imu_debug_send_struct(mavlink_channel_t chan, const mavlink_imu_debug_t* imu_debug)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_imu_debug_send(chan, imu_debug->time_boot_ms, imu_debug->Ax, imu_debug->Ay, imu_debug->Az, imu_debug->Gx_u, imu_debug->Gy_u, imu_debug->Gz_u, imu_debug->Mx, imu_debug->My, imu_debug->Mz, imu_debug->IMU_temp);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_IMU_DEBUG, (const char *)imu_debug, MAVLINK_MSG_ID_IMU_DEBUG_MIN_LEN, MAVLINK_MSG_ID_IMU_DEBUG_LEN, MAVLINK_MSG_ID_IMU_DEBUG_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_IMU_DEBUG_LEN? msg->len : MAVLINK_MSG_ID_IMU_DEBUG_LEN;
        memset(imu_debug, 0, MAVLINK_MSG_ID_IMU_DEBUG_LEN);
    memcpy(imu_debug, _MAV_PAYLOAD(msg), len);
#endif
}
