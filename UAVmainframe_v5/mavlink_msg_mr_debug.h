						       ...
						       uint32_t time_boot_ms, uint16_t RPM_1, uint16_t RPM_2, uint16_t RPM_3, uint16_t RPM_4, uint16_t RPM_5, uint16_t RPM_6)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_MR_DEBUG_LEN, MAVLINK_MSG_ID_MR_DEBUG_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_MR_DEBUG_LEN);
#endif
}
						           ...
						           uint32_t time_boot_ms,uint16_t RPM_1,uint16_t RPM_2,uint16_t RPM_3,uint16_t RPM_4,uint16_t RPM_5,uint16_t RPM_6)
{
	...
	msg->msgid = MAVLINK_MSG_ID_MR_DEBUG;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_MR_DEBUG_LEN, MAVLINK_MSG_ID_MR_DEBUG_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_MR_DEBUG_LEN);
#endif
}
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MR_DEBUG, buf, MAVLINK_MSG_ID_MR_DEBUG_LEN, MAVLINK_MSG_ID_MR_DEBUG_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MR_DEBUG, buf, MAVLINK_MSG_ID_MR_DEBUG_LEN);
#endif
#else
	mavlink_mr_debug_t packet;
	packet.time_boot_ms = time_boot_ms;
...
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MR_DEBUG, (const char *)&packet, MAVLINK_MSG_ID_MR_DEBUG_LEN, MAVLINK_MSG_ID_MR_DEBUG_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_MR_DEBUG, (const char *)&packet, MAVLINK_MSG_ID_MR_DEBUG_LEN);
#endif
#endif
}
...
#else
	memcpy(mr_debug, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_MR_DEBUG_LEN);
#endif
}
