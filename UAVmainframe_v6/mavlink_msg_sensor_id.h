						       ...
						       const char *name, uint8_t version_high, uint8_t version_low, const char *configuration)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_SENSOR_ID_LEN, MAVLINK_MSG_ID_SENSOR_ID_CRC);
#else
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_SENSOR_ID_LEN);
#endif
}
						           ...
						           const char *name,uint8_t version_high,uint8_t version_low,const char *configuration)
{
	...
	msg->msgid = MAVLINK_MSG_ID_SENSOR_ID;
#if MAVLINK_CRC_EXTRA
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_SENSOR_ID_LEN, MAVLINK_MSG_ID_SENSOR_ID_CRC);
#else
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_SENSOR_ID_LEN);
#endif
}
...
static inline void mavlink_msg_sensor_id_send(mavlink_channel_t chan, const char *name, uint8_t version_high, uint8_t version_low, const char *configuration)
{
	...
	_mav_put_char_array(buf, 12, configuration, 10);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SENSOR_ID, buf, MAVLINK_MSG_ID_SENSOR_ID_LEN, MAVLINK_MSG_ID_SENSOR_ID_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SENSOR_ID, buf, MAVLINK_MSG_ID_SENSOR_ID_LEN);
#endif
#else
	mavlink_sensor_id_t packet;
	packet.version_high = version_high;
	...
	mav_array_memcpy(packet.configuration, configuration, sizeof(char)*10);
#if MAVLINK_CRC_EXTRA
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SENSOR_ID, (const char *)&packet, MAVLINK_MSG_ID_SENSOR_ID_LEN, MAVLINK_MSG_ID_SENSOR_ID_CRC);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_SENSOR_ID, (const char *)&packet, MAVLINK_MSG_ID_SENSOR_ID_LEN);
#endif
#endif
}
...
#else
	memcpy(sensor_id, _MAV_PAYLOAD(msg), MAVLINK_MSG_ID_SENSOR_ID_LEN);
#endif
}
