...
#define MAVLINK_MSG_ID_EULER_DEBUG_MIN_LEN 28
#define MAVLINK_MSG_ID_180_LEN 28
#define MAVLINK_MSG_ID_180_MIN_LEN 28
                               ...
                               uint32_t time_boot_ms, float IMU_roll, float IMU_pitch, float IMU_yaw, float GBL_roll, float GBL_pitch, float GBL_yaw)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_EULER_DEBUG_MIN_LEN, MAVLINK_MSG_ID_EULER_DEBUG_LEN, MAVLINK_MSG_ID_EULER_DEBUG_CRC);
}
                                   ...
                                   uint32_t time_boot_ms,float IMU_roll,float IMU_pitch,float IMU_yaw,float GBL_roll,float GBL_pitch,float GBL_yaw)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_EULER_DEBUG;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_EULER_DEBUG_MIN_LEN, MAVLINK_MSG_ID_EULER_DEBUG_LEN, MAVLINK_MSG_ID_EULER_DEBUG_CRC);
}
...
static inline void mavlink_msg_euler_debug_send(mavlink_channel_t chan, uint32_t time_boot_ms, float IMU_roll, float IMU_pitch, float IMU_yaw, float GBL_roll, float GBL_pitch, float GBL_yaw)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EULER_DEBUG, buf, MAVLINK_MSG_ID_EULER_DEBUG_MIN_LEN, MAVLINK_MSG_ID_EULER_DEBUG_LEN, MAVLINK_MSG_ID_EULER_DEBUG_CRC);
#else
    mavlink_euler_debug_t packet;
    packet.time_boot_ms = time_boot_ms;
    packet.IMU_roll = IMU_roll;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EULER_DEBUG, (const char *)&packet, MAVLINK_MSG_ID_EULER_DEBUG_MIN_LEN, MAVLINK_MSG_ID_EULER_DEBUG_LEN, MAVLINK_MSG_ID_EULER_DEBUG_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_euler_debug_send_struct(mavlink_channel_t chan, const mavlink_euler_debug_t* euler_debug)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_euler_debug_send(chan, euler_debug->time_boot_ms, euler_debug->IMU_roll, euler_debug->IMU_pitch, euler_debug->IMU_yaw, euler_debug->GBL_roll, euler_debug->GBL_pitch, euler_debug->GBL_yaw);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_EULER_DEBUG, (const char *)euler_debug, MAVLINK_MSG_ID_EULER_DEBUG_MIN_LEN, MAVLINK_MSG_ID_EULER_DEBUG_LEN, MAVLINK_MSG_ID_EULER_DEBUG_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_EULER_DEBUG_LEN? msg->len : MAVLINK_MSG_ID_EULER_DEBUG_LEN;
        memset(euler_debug, 0, MAVLINK_MSG_ID_EULER_DEBUG_LEN);
    memcpy(euler_debug, _MAV_PAYLOAD(msg), len);
#endif
}
