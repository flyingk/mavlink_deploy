...
#define MAVLINK_MSG_ID_TECS_DEBUG_MIN_LEN 52
#define MAVLINK_MSG_ID_201_LEN 52
#define MAVLINK_MSG_ID_201_MIN_LEN 52
                               ...
                               uint32_t time_boot_ms, float Alt_Dem, float Spd_Dem, float tecs_SPE_dem, float tecs_SKE_dem, float tecs_STE_dem, float tecs_SEB_dem, float tecs_SPE_est, float tecs_SKE_est, float tecs_STE_est, float tecs_SEB_est, float Pitch_Dem, float Thr_Dem)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_TECS_DEBUG_MIN_LEN, MAVLINK_MSG_ID_TECS_DEBUG_LEN, MAVLINK_MSG_ID_TECS_DEBUG_CRC);
}
                                   ...
                                   uint32_t time_boot_ms,float Alt_Dem,float Spd_Dem,float tecs_SPE_dem,float tecs_SKE_dem,float tecs_STE_dem,float tecs_SEB_dem,float tecs_SPE_est,float tecs_SKE_est,float tecs_STE_est,float tecs_SEB_est,float Pitch_Dem,float Thr_Dem)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_TECS_DEBUG;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_TECS_DEBUG_MIN_LEN, MAVLINK_MSG_ID_TECS_DEBUG_LEN, MAVLINK_MSG_ID_TECS_DEBUG_CRC);
}
...
static inline void mavlink_msg_tecs_debug_send(mavlink_channel_t chan, uint32_t time_boot_ms, float Alt_Dem, float Spd_Dem, float tecs_SPE_dem, float tecs_SKE_dem, float tecs_STE_dem, float tecs_SEB_dem, float tecs_SPE_est, float tecs_SKE_est, float tecs_STE_est, float tecs_SEB_est, float Pitch_Dem, float Thr_Dem)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_TECS_DEBUG, buf, MAVLINK_MSG_ID_TECS_DEBUG_MIN_LEN, MAVLINK_MSG_ID_TECS_DEBUG_LEN, MAVLINK_MSG_ID_TECS_DEBUG_CRC);
#else
    mavlink_tecs_debug_t packet;
    packet.time_boot_ms = time_boot_ms;
    packet.Alt_Dem = Alt_Dem;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_TECS_DEBUG, (const char *)&packet, MAVLINK_MSG_ID_TECS_DEBUG_MIN_LEN, MAVLINK_MSG_ID_TECS_DEBUG_LEN, MAVLINK_MSG_ID_TECS_DEBUG_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_tecs_debug_send_struct(mavlink_channel_t chan, const mavlink_tecs_debug_t* tecs_debug)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_tecs_debug_send(chan, tecs_debug->time_boot_ms, tecs_debug->Alt_Dem, tecs_debug->Spd_Dem, tecs_debug->tecs_SPE_dem, tecs_debug->tecs_SKE_dem, tecs_debug->tecs_STE_dem, tecs_debug->tecs_SEB_dem, tecs_debug->tecs_SPE_est, tecs_debug->tecs_SKE_est, tecs_debug->tecs_STE_est, tecs_debug->tecs_SEB_est, tecs_debug->Pitch_Dem, tecs_debug->Thr_Dem);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_TECS_DEBUG, (const char *)tecs_debug, MAVLINK_MSG_ID_TECS_DEBUG_MIN_LEN, MAVLINK_MSG_ID_TECS_DEBUG_LEN, MAVLINK_MSG_ID_TECS_DEBUG_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_TECS_DEBUG_LEN? msg->len : MAVLINK_MSG_ID_TECS_DEBUG_LEN;
        memset(tecs_debug, 0, MAVLINK_MSG_ID_TECS_DEBUG_LEN);
    memcpy(tecs_debug, _MAV_PAYLOAD(msg), len);
#endif
}
