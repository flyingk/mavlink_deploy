...
typedef struct __mavlink_ekf_debug_t
{
 ...
 int16_t GX_b__mdeg/s; /*< Estimated gyro x bias [deg/s]*/
 int16_t GY_b__mdeg/s; /*< Estimated gyro y bias [deg/s]*/
 int16_t GZ_b__mdeg/s; /*< Estimated gyro z bias [deg/s]*/
 ...
 int16_t Vair_b__cm/s; /*< Estimated Vair bias [mg]*/
...
#define MAVLINK_MSG_ID_EKF_DEBUG_CRC 97
#define MAVLINK_MSG_ID_199_CRC 97
...
#define MAVLINK_MESSAGE_INFO_EKF_DEBUG { \
	...
	{  { "time_boot_ms", NULL, MAVLINK_TYPE_UINT32_T, 0, 0, offsetof(mavlink_ekf_debug_t, time_boot_ms) }, \
         { "GX_b__mdeg/s", NULL, MAVLINK_TYPE_INT16_T, 0, 4, offsetof(mavlink_ekf_debug_t, GX_b__mdeg/s) }, \
         { "GY_b__mdeg/s", NULL, MAVLINK_TYPE_INT16_T, 0, 6, offsetof(mavlink_ekf_debug_t, GY_b__mdeg/s) }, \
         { "GZ_b__mdeg/s", NULL, MAVLINK_TYPE_INT16_T, 0, 8, offsetof(mavlink_ekf_debug_t, GZ_b__mdeg/s) }, \
         ...
         { "Vair_b__cm/s", NULL, MAVLINK_TYPE_INT16_T, 0, 22, offsetof(mavlink_ekf_debug_t, Vair_b__cm/s) }, \
 ...
 * @param GX_b__mdeg/s Estimated gyro x bias [deg/s]
 * @param GY_b__mdeg/s Estimated gyro y bias [deg/s]
 * @param GZ_b__mdeg/s Estimated gyro z bias [deg/s]
 ...
 * @param Vair_b__cm/s Estimated Vair bias [mg]
...
static inline uint16_t mavlink_msg_ekf_debug_pack(uint8_t system_id, uint8_t component_id, mavlink_message_t* msg,
						       uint32_t time_boot_ms, int16_t GX_b__mdeg/s, int16_t GY_b__mdeg/s, int16_t GZ_b__mdeg/s, int16_t AX_b__mg, int16_t AY_b__mg, int16_t AZ_b__mg, int16_t MX_b__mG, int16_t MY_b__mG, int16_t MZ_b__mG, int16_t Vair_b__cm/s, int16_t AoA_b__mdeg, int16_t CW_b__mdeg, int16_t Alt_b__cm, int16_t Vair_scale, int16_t AoA_scale, int16_t CW_scale)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_EKF_DEBUG_LEN];
	_mav_put_uint32_t(buf, 0, time_boot_ms);
	_mav_put_int16_t(buf, 4, GX_b__mdeg/s);
	_mav_put_int16_t(buf, 6, GY_b__mdeg/s);
	_mav_put_int16_t(buf, 8, GZ_b__mdeg/s);
	...
	_mav_put_int16_t(buf, 22, Vair_b__cm/s);
	...
	packet.GX_b__mdeg/s = GX_b__mdeg/s;
	packet.GY_b__mdeg/s = GY_b__mdeg/s;
	packet.GZ_b__mdeg/s = GZ_b__mdeg/s;
	...
	packet.Vair_b__cm/s = Vair_b__cm/s;
...
{
	return mavlink_msg_ekf_debug_pack(system_id, component_id, msg, ekf_debug->time_boot_ms, ekf_debug->GX_b__mdeg/s, ekf_debug->GY_b__mdeg/s, ekf_debug->GZ_b__mdeg/s, ekf_debug->AX_b__mg, ekf_debug->AY_b__mg, ekf_debug->AZ_b__mg, ekf_debug->MX_b__mG, ekf_debug->MY_b__mG, ekf_debug->MZ_b__mG, ekf_debug->Vair_b__cm/s, ekf_debug->AoA_b__mdeg, ekf_debug->CW_b__mdeg, ekf_debug->Alt_b__cm, ekf_debug->Vair_scale, ekf_debug->AoA_scale, ekf_debug->CW_scale);
}
...
{
	return mavlink_msg_ekf_debug_pack_chan(system_id, component_id, chan, msg, ekf_debug->time_boot_ms, ekf_debug->GX_b__mdeg/s, ekf_debug->GY_b__mdeg/s, ekf_debug->GZ_b__mdeg/s, ekf_debug->AX_b__mg, ekf_debug->AY_b__mg, ekf_debug->AZ_b__mg, ekf_debug->MX_b__mG, ekf_debug->MY_b__mG, ekf_debug->MZ_b__mG, ekf_debug->Vair_b__cm/s, ekf_debug->AoA_b__mdeg, ekf_debug->CW_b__mdeg, ekf_debug->Alt_b__cm, ekf_debug->Vair_scale, ekf_debug->AoA_scale, ekf_debug->CW_scale);
}
...
static inline void mavlink_msg_ekf_debug_send(mavlink_channel_t chan, uint32_t time_boot_ms, int16_t GX_b__mdeg/s, int16_t GY_b__mdeg/s, int16_t GZ_b__mdeg/s, int16_t AX_b__mg, int16_t AY_b__mg, int16_t AZ_b__mg, int16_t MX_b__mG, int16_t MY_b__mG, int16_t MZ_b__mG, int16_t Vair_b__cm/s, int16_t AoA_b__mdeg, int16_t CW_b__mdeg, int16_t Alt_b__cm, int16_t Vair_scale, int16_t AoA_scale, int16_t CW_scale)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
	char buf[MAVLINK_MSG_ID_EKF_DEBUG_LEN];
	_mav_put_uint32_t(buf, 0, time_boot_ms);
 ...
 */
static inline void mavlink_msg_ekf_debug_send_buf(mavlink_message_t *msgbuf, mavlink_channel_t chan,  uint32_t time_boot_ms, int16_t GX_b__mdeg/s, int16_t GY_b__mdeg/s, int16_t GZ_b__mdeg/s, int16_t AX_b__mg, int16_t AY_b__mg, int16_t AZ_b__mg, int16_t MX_b__mG, int16_t MY_b__mG, int16_t MZ_b__mG, int16_t Vair_b__cm/s, int16_t AoA_b__mdeg, int16_t CW_b__mdeg, int16_t Alt_b__cm, int16_t Vair_scale, int16_t AoA_scale, int16_t CW_scale)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
...
/**
 * @brief Get field GX_b__mdeg/s from ekf_debug message
 *
 * @return Estimated gyro x bias [deg/s]
 */
static inline int16_t mavlink_msg_ekf_debug_get_GX_b__mdeg/s(const mavlink_message_t* msg)
{
	return _MAV_RETURN_int16_t(msg,  4);
}

/**
 * @brief Get field GY_b__mdeg/s from ekf_debug message
 *
 * @return Estimated gyro y bias [deg/s]
 */
static inline int16_t mavlink_msg_ekf_debug_get_GY_b__mdeg/s(const mavlink_message_t* msg)
{
	return _MAV_RETURN_int16_t(msg,  6);
}

/**
 * @brief Get field GZ_b__mdeg/s from ekf_debug message
 *
 * @return Estimated gyro z bias [deg/s]
 */
static inline int16_t mavlink_msg_ekf_debug_get_GZ_b__mdeg/s(const mavlink_message_t* msg)
{
...
/**
 * @brief Get field Vair_b__cm/s from ekf_debug message
 *
 * @return Estimated Vair bias [mg]
 */
static inline int16_t mavlink_msg_ekf_debug_get_Vair_b__cm/s(const mavlink_message_t* msg)
{
...
static inline void mavlink_msg_ekf_debug_decode(const mavlink_message_t* msg, mavlink_ekf_debug_t* ekf_debug)
{
	...
	ekf_debug->GX_b__mdeg/s = mavlink_msg_ekf_debug_get_GX_b__mdeg/s(msg);
	ekf_debug->GY_b__mdeg/s = mavlink_msg_ekf_debug_get_GY_b__mdeg/s(msg);
	ekf_debug->GZ_b__mdeg/s = mavlink_msg_ekf_debug_get_GZ_b__mdeg/s(msg);
	...
	ekf_debug->Vair_b__cm/s = mavlink_msg_ekf_debug_get_Vair_b__cm/s(msg);
