...
#define MAVLINK_MSG_ID_Longitudinal_MIN_LEN 36
#define MAVLINK_MSG_ID_191_LEN 36
#define MAVLINK_MSG_ID_191_MIN_LEN 36
                               ...
                               uint32_t time_boot_ms, float AoA_cal, float q, float ax, float az, float IMU_pitch, float GBL_pitch, float elevator, float elevator_cmd)
{
    ...
    return mavlink_finalize_message(msg, system_id, component_id, MAVLINK_MSG_ID_Longitudinal_MIN_LEN, MAVLINK_MSG_ID_Longitudinal_LEN, MAVLINK_MSG_ID_Longitudinal_CRC);
}
                                   ...
                                   uint32_t time_boot_ms,float AoA_cal,float q,float ax,float az,float IMU_pitch,float GBL_pitch,float elevator,float elevator_cmd)
{
    ...
    msg->msgid = MAVLINK_MSG_ID_Longitudinal;
    return mavlink_finalize_message_chan(msg, system_id, component_id, chan, MAVLINK_MSG_ID_Longitudinal_MIN_LEN, MAVLINK_MSG_ID_Longitudinal_LEN, MAVLINK_MSG_ID_Longitudinal_CRC);
}
...
static inline void mavlink_msg_longitudinal_send(mavlink_channel_t chan, uint32_t time_boot_ms, float AoA_cal, float q, float ax, float az, float IMU_pitch, float GBL_pitch, float elevator, float elevator_cmd)
{
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Longitudinal, buf, MAVLINK_MSG_ID_Longitudinal_MIN_LEN, MAVLINK_MSG_ID_Longitudinal_LEN, MAVLINK_MSG_ID_Longitudinal_CRC);
#else
    mavlink_longitudinal_t packet;
    packet.time_boot_ms = time_boot_ms;
    packet.AoA_cal = AoA_cal;
    ...
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Longitudinal, (const char *)&packet, MAVLINK_MSG_ID_Longitudinal_MIN_LEN, MAVLINK_MSG_ID_Longitudinal_LEN, MAVLINK_MSG_ID_Longitudinal_CRC);
#endif
}
 ...
 */
static inline void mavlink_msg_longitudinal_send_struct(mavlink_channel_t chan, const mavlink_longitudinal_t* longitudinal)
{
#if MAVLINK_NEED_BYTE_SWAP || !MAVLINK_ALIGNED_FIELDS
    mavlink_msg_longitudinal_send(chan, longitudinal->time_boot_ms, longitudinal->AoA_cal, longitudinal->q, longitudinal->ax, longitudinal->az, longitudinal->IMU_pitch, longitudinal->GBL_pitch, longitudinal->elevator, longitudinal->elevator_cmd);
#else
    _mav_finalize_message_chan_send(chan, MAVLINK_MSG_ID_Longitudinal, (const char *)longitudinal, MAVLINK_MSG_ID_Longitudinal_MIN_LEN, MAVLINK_MSG_ID_Longitudinal_LEN, MAVLINK_MSG_ID_Longitudinal_CRC);
#endif
}
...
#else
        uint8_t len = msg->len < MAVLINK_MSG_ID_Longitudinal_LEN? msg->len : MAVLINK_MSG_ID_Longitudinal_LEN;
        memset(longitudinal, 0, MAVLINK_MSG_ID_Longitudinal_LEN);
    memcpy(longitudinal, _MAV_PAYLOAD(msg), len);
#endif
}
